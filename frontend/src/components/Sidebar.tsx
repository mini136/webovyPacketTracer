...
export default function Sidebar({ onOpenNetworkTools }: SidebarProps) {
  ...
  const handleCreateSampleNetwork = () => {
            ...
            },
            {
              ...
              subInterfaces: [
                ...
                },
                {
                  ...
                  subnetMask: "255.255.255.0",
                  ipv6Address: "2001:db8:40::1",
                  ipv6PrefixLength: 64,
                  ipv6Enabled: true,
                  description: "VLAN 40 - PC4",
                },
              ],
            },
            { name: "Gig0/2" },
          ...
          interfaces: [
            {
              ...
              vlanId: 1,
              trunkMode: true,
              description: "802.1Q trunk to Router-1",
            },
          ...
          interfaces: [
            {
              ...
              vlanId: 1,
              trunkMode: true,
              description: "802.1Q trunk to Router-2",
            },
          ...
          interfaces: [
            {
              ...
              ipv6Address: "2001:db8:30::10",
              ipv6PrefixLength: 64,
              ipv6Gateway: "2001:db8:30::1",
              ipv6Enabled: true,
            },
          ],
        },
          ...
          interfaces: [
            {
              ...
              ipv6Address: "2001:db8:40::10",
              ipv6PrefixLength: 64,
              ipv6Gateway: "2001:db8:40::1",
              ipv6Enabled: true,
            },
          ],
        },
    ...
    alert(
      "✅ Ukázková síť vytvořena s IPv4 a IPv6!\n\n📍 VLAN 10 - PC-1:\n  IPv4: 192.168.10.10/24 → GW 192.168.10.1\n  IPv6: 2001:db8:10::10/64 → GW 2001:db8:10::1\n\n📍 VLAN 20 - PC-2:\n  IPv4: 192.168.20.10/24 → GW 192.168.20.1\n  IPv6: 2001:db8:20::10/64 → GW 2001:db8:20::1\n\n📍 VLAN 30 - PC-3:\n  IPv4: 192.168.30.10/24 → GW 192.168.30.1\n  IPv6: 2001:db8:30::10/64 → GW 2001:db8:30::1\n\n📍 VLAN 40 - PC-4:\n  IPv4: 192.168.40.10/24 → GW 192.168.40.1\n  IPv6: 2001:db8:40::10/64 → GW 2001:db8:40::1\n\n🔗 Inter-Router Link:\n  IPv4: 10.0.0.1 ↔ 10.0.0.2\n  IPv6: 2001:db8:ffff::1 ↔ 2001:db8:ffff::2\n\n🗺️ Routing tables (IPv4 + IPv6) nakonfigurovány!\n💡 Zkus: show ipv6 interface brief / show ipv6 route"
    );
  };
  ...
  return (
    ...
    >
      ...
      {showSubnettingCalc && (
        <SubnettingCalculator onClose={() => setShowSubnettingCalc(false)} />
      )}
    </div>
  );
}
